...
const {data:session}=useSession()
  return (
    <>
      <div className="bg-white flex justify-between items-center p-2 shadow-2xl py-2 fixed top-0 left-0 z-50 w-full">
        <div className="flex space-x-2 items-center">
          <BsFacebook className="text-primary text-[40px]" />
          <div className="relative">
            <AiOutlineSearch className="absolute top-[30%] left-[5%] text-gray-600" />
            <input
              type="text"
              className="p-2 rounded-xl pl-10 bg-black/20 focus:outline-none"
        ...
        <div className="flex items-center gap-7">
          <div>
            <CgMenuGridO className="icon_wrapper text-[20px]"/>
          </div>
          <div>
            <BsMessenger className="icon_wrapper text-[20px]"/>
          </div>
          <div>
